...
import clases.ENTIDAD_PRODUCTO;
 ...
 * @author manue
 */
public class CInventario_ADMIN {
    ...
    public void MostrarProductos(JTable TablaProductos, JTextField txt_busqueda){
        ...
        modelo.addColumn("Categoria Asociada");
        ...
        sql = "select Productos.codigo_producto, Productos.nombre, Productos.descripcion, Categorias.nombre_categoria, Productos.precio_compra, Productos.precio_venta, Productos.fecha_vencimiento, Productos.stock_actual, Productos.stock_minimo,Proveedores.nombre_proveedor\n" +
"From Productos\n" +
...
"where Productos.codigo_producto like '%"+busqueda+"%'";
    ...
    public void ListarProductos(JTable TablaProductos, JTextField txt_busqueda){
      ...
      String consulta = "select Productos.codigo_producto, Productos.nombre, Productos.descripcion, Productos.id_categoria, Categorias.nombre_categoria, Productos.precio_compra, Productos.precio_venta, Productos.fecha_vencimiento, Productos.stock_actual, Productos.stock_minimo,Productos.id_proveedor,Proveedores.nombre_proveedor\n" +
        "From Productos\n" +
        "INNER JOIN Categorias on Productos.id_categoria = Categorias.id_categoria\n" +
        "INNER JOIN Proveedores on Productos.id_proveedor = Proveedores.id_proveedor\n" +
        "where Productos.codigo_producto like '%"+busqueda+"%'";
        try {
          ...
          while(rs.next()){
              ...
              modelo.addRow(new Object[]{producto.getCodigo_producto(),producto.getNombre(),producto.getDescripcion(),rs.getString("nombre_categoria"),producto.getPrecio_compra(),producto.getPrecio_venta(),producto.getFecha_vencimiento(),producto.getStock_actual(),producto.getStock_minimo(),rs.getString("nombre_proveedor")});          
          }
          TablaProductos.setModel(modelo);
        } 
        catch (SQLException e) {
